...
public class GenBlocks implements ContentList {
                ...
                this.ammo(
                        ModItems.exoticAlloy, new BasicBulletType() {
...

                            {
                                ...
                                this.lifetime = 90;
                                this.knockback = 1;
                                this.lightning = 3;//количество молний
                                this.lightningLength = 5;//длина молнии
                                this.lightningLengthRand = 15;//рандомное число от 0 до 50 будет прибавляться к длине молнии, то есть рандомизация длины
                                this.lightningDamage = 12;//урон молнии
                                this.lightningAngle = 5;//угол направления молний относительно угла пули
                                this.lightningCone = 45;//рандомизация угла направления молний
        ...
        electron = new LaserTurret("electron") {
            {
                ...
                this.shootType = new ContinuousLaserBulletType() {
...

                    {
                        ...
                        this.despawnEffect = Fx.railHit;
                        this.knockback = 1;
                        this.lightning = 4;//количество молний
                        this.lightningLength = 30;//длина молнии
                        this.lightningLengthRand = 30;//рандомное число от 0 до 50 будет прибавляться к длине молнии, то есть рандомизация длины
                        this.lightningDamage = 78;//урон молнии
                        this.lightningAngle = 15;//угол направления молний относительно угла пули
                        this.lightningCone = 50;//рандомизация угла направления молний
                        this.lightningColor = Color.valueOf("f1fc58");
                    }
                };
                ...
                this.ammo(
                        Items.silicon, new BasicBulletType() {
...

                            {
                                ...
                                this.knockback = 1;
                                this.lightning = 3;//количество молний
                                this.lightningLength = 3;//длина молнии
                                this.lightningLengthRand = 7;//рнадомная длина
                                this.lightningDamage = 20;//урон молнии
                                this.lightningAngle = 3;//угол направления молний относительно угла пули
                                this.lightningCone = 20;//рандомизация угла направления молний
                                this.lightningColor = Color.valueOf("f1fc58");
                            }
                        }
                );
                ...
                this.ammo(
                        Items.plastanium, new SapBulletType() {
...

                            {
                                ...
                                this.knockback = -1;
                                this.lightning = 4;//количество молний
                                this.lightningLength = 2;//длина молнии
                                this.lightningLengthRand = 10;//рандомное число от 0 до 15 будет прибавляться к длине молнии, то есть рандомизация длины
                                this.lightningDamage = 50;//урон молнии
                                this.lightningAngle = 6;//угол направления молний относительно угла пули
                                this.lightningCone = 12;//рандомизация угла направления молний
//                                this.largeHit = true;
