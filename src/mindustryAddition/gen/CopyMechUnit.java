...
public class CopyMechUnit extends Unit implements Itemsc, Minerc, ElevationMovec, Flyingc, Entityc, Statusc, Healthc, Commanderc, Hitboxc, Physicsc, Weaponsc, Builderc, Posc, Velc, Rotc, Shieldc, Drawc, Teamc, Boundedc, Mechc, Syncc, Unitc {
  ...
  public Object senseObject(LAccess sensor) {
        ...
        case payloadType ->this instanceof Payloadc pay ? (pay.payloads().isEmpty() ? null : pay.payloads().peek() instanceof UnitPayload p1 ? p1.unit.type : pay.payloads().peek() instanceof BuildPayload p2 ? p2.block() : null) : null;
        default ->noSensed;
        };
  }
  ...
  public double sense(LAccess sensor) {
        ...
        case payloadCount ->this instanceof Payloadc pay ? pay.payloads().size : 0;
        default ->0;
        };
  }
  ...
  public void update() {
    ...
    commander: {
        ...
        if (formation != null) {
            ...
            controlling.removeAll((u)->u.dead || !(u.controller() instanceof FormationAI ai && ai.leader == this));
        }
    }
    hitbox: {
    }
