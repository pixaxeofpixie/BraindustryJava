...
public class ImpactReactorUnitAbility extends PowerUnitAbility{
    public TextureRegion light;
    public TextureRegion[] plasmaRegions;
    public Color plasma1, plasma2;
    public ImpactReactorUnitAbility(ModUnitType unitType, float range, float powerProduction, int maxNodes, Vec2 reactorOffset) {
    ...
    public ImpactReactorUnitAbility(ModUnitType unitType, float range, float powerProduction, int maxNodes) {
