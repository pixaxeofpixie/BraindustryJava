...
public class BlackHoleReactorUnitAbility extends PowerUnitAbility{
    public float blackHoleHitSize;

    public BlackHoleReactorUnitAbility(ModUnitType unitType, float range, float powerProduction, int maxNodes,float blackHoleHitSize, Vec2 reactorOffset) {
        super(unitType, range, powerProduction, maxNodes, reactorOffset);
        this.blackHoleHitSize=blackHoleHitSize;
    }
    public BlackHoleReactorUnitAbility(ModUnitType unitType, float range, float powerProduction, int maxNodes,float blackHoleHitSize) {
